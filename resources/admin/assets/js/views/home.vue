...
import TotalSessions from "../components/widgets/total-sessions";
import TotalSales from "../components/widgets/total-sales";

/**
 * Dashboard Component
 */
export default {
  components: { Layout, Profile, Stat, Transaction, Earning, Emailsent, TotalSales, TotalSessions },
  data() {
    return {
      title: "Dashboard",
      statData: [
...
<!--            </div>-->
      ...
      <div class="col-xl-4">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title mb-4">Top Collections</h4>
